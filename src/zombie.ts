import GameObject, { Attacker, GEvent, Life, ObjectPool } from './gameObject';
import { Human } from './human';
import { Sprite } from './sprite';
import { distance, Position, toGlobal, xToRadian } from './position';
...
export class Zombie extends GameObject implements Life, Attacker{
  ...
  constructor(human: Human) {
    ...
    this.addListener("zombieDie", event=>{this.die()})
  }
